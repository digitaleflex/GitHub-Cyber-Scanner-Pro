...
STOP_WORDS = {"a", "an", "the", "and", "or", "but", "for", "of", "to", "in", "on", "at", "by", "with", "from",
    "as", "is", "are", "was", "were", "be", "been", "being", "have", "has", "had", "do", "does", "did",
    "will", "would", "could", "should", "may", "might", "can", "cannot", "must", "shall", "not", "no", "yes",
    "so", "if", "then", "than", "that", "this", "these", "those", "it", "its", "he", "she", "him", "her",
    "his", "they", "them", "their", "we", "us", "our", "you", "your", "my", "me", "i", "am", "who", "what",
    "which", "where", "when", "why", "how", "all", "any", "some", "many", "much", "few", "more", "most",
    "other", "another", "such", "only", "own", "same", "each", "every", "both", "either", "neither", "one",
    "two", "three", "first", "last", "new", "old", "good", "bad", "big", "small", "long", "short", "high",
    "low", "right", "left", "here", "there", "now", "today", "tomorrow", "yesterday", "way", "just", "also",
    "too", "very", "quite", "rather", "still", "yet", "already", "almost", "even", "about", "above", "across",
    "after", "against", "along", "among", "around", "before", "behind", "below", "beneath", "beside",
    "between", "beyond", "during", "inside", "into", "near", "off", "onto", "out", "outside", "over",
    "through", "throughout", "till", "toward", "under", "until", "up", "upon", "within", "without", "via",
    "using", "based", "tool", "tools", "library", "libraries", "framework", "platform", "application", "app",
    "software", "program", "project", "simple", "easy", "fast", "lightweight", "written", "built", "made",
    "provides", "allows", "supports", "includes", "used", "use", "useful", "set", "collection", "list",
    "script", "cli", "gui", "implementation", "implement", "source", "code", "open", "repository", "repo",
    "github", "gitlab", "version", "latest", "release", "update", "updated", "create", "created", "creates",
    "creating", "make", "making", "build", "building", "designed", "help", "helps", "helping", "allow",
    "allowing", "enable", "enables", "support", "supporting", "include", "including", "provide", "providing",
    "contain", "contains", "containing", "feature", "features", "powered", "fork", "mirror", "clone",
    "download", "install", "setup", "configure", "configuration", "config", "documentation", "docs", "guide",
    "tutorial", "example", "examples", "sample", "samples", "template", "templates", "test", "tests",
    "testing", "benchmark", "benchmarks", "demo", "demos", "showcase", "resource", "resources", "reference",
    "awesome", "curated", "lists", "repositories", "database", "dataset", "data", "files", "file", "folder",
    "directory", "path", "paths", "url", "link", "links", "page", "pages", "website", "web", "site", "online",
    "api", "apis", "json", "xml", "yaml", "csv", "format", "formats", "html", "css", "javascript", "js",
    "typescript", "ts", "python", "java", "go", "golang", "rust", "cpp", "c", "csharp", "ruby", "php",
    "swift", "kotlin", "scala", "r", "matlab", "shell", "bash", "powershell", "sql", "perl", "linux",
    "windows", "macos", "mac", "unix", "ubuntu", "debian", "centos", "redhat", "fedora", "android", "ios",
    "mobile", "desktop", "server", "client", "frontend", "backend", "fullstack", "webapp", "webapps"}
