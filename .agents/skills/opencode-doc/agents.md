...
> **Tip:** If you don't specify a model, primary agents use the [model globally configured](config.md#models) while subagents will use the model of the primary agent that invoked the subagent.
