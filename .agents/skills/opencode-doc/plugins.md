...
For examples, check out the [plugins](ecosystem.md#plugins) created by the community.
...
Browse available plugins in the [ecosystem](ecosystem.md#plugins).
...
**Local plugins** are loaded directly from the plugin directory. To use external packages, you must create a `package.json` within your config directory (see [Dependencies](#dependencies)), or publish the plugin to npm and [add it to your config](config.md#plugins).
