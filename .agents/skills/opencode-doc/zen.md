...
The [model id](config.md#models) in your OpenCode config uses the format `opencode/<model-id>`. For example, for GPT 5.2 Codex, you would use `opencode/gpt-5.2-codex` in your config.
...
You might notice *Claude Haiku 3.5* in your usage history. This is a [low cost model](config.md#models) that's used to generate the titles of your sessions.
