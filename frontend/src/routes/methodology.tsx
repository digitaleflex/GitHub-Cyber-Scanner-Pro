...
function MethodologyPage() {
  const sections = [
    {
      icon: <Database size={16} style={{ color: 'var(--warning)' }} />,
    ...
    {
      icon: <Target size={16} style={{ color: 'var(--danger)' }} />,
    ...
    {
      icon: <Shield size={16} style={{ color: 'var(--info)' }} />,
  ...
  return (
    <div className="max-w-[900px] mx-auto py-8 sm:py-16 animate-fade">
      ...
      <div className="surface rounded-2xl p-5 mt-8 text-center" style={{ border: '1px solid var(--border)' }}>
        <div className="flex items-center justify-center gap-2 mb-2"><Cpu size={18} style={{ color: 'var(--brand)' }} /><h2 className="h3" style={{ color: 'var(--text)' }}>Formule de score final</h2></div>
